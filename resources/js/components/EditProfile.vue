            ...
            <div class="col-12 col-md-6 mt-5">
                ...
                <form @submit.prevent="updateProfile">
                    <div class="form-group" >
                        <label for="shop_name" class="form control">EmployeeName:</label>
                        <input autocomplete="off" v-model="form.shop_name" type="text" name="EmployeeName" id="shop_name" placeholder="EmployeeName"
